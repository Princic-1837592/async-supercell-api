...
class ClanWarClan(SupercellApiResponse):
    def __init__(self, crowns: Optional[int] = None, tag: Optional[str] = None, clanScore: Optional[int] = None, badgeId: Optional[int] = None,
                 name: Optional[str] = None, participants: Optional[int] = None, battlesPlayed: Optional[int] = None, wins: Optional[int] = None,
                 **kwargs):
...
class ClanWarParticipant(SupercellApiResponse):
    def __init__(self, tag: Optional[str] = None, name: Optional[str] = None, cardsEarned: Optional[int] = None,
                 battlesPlayed: Optional[int] = None, wins: Optional[int] = None, collectionDayBattlesPlayed: Optional[int] = None,
...
class JsonLocalizedName(SupercellApiResponse):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)


class Arena(SupercellApiResponse):
    def __init__(self, name: Optional[dict] = None, id: Optional[int] = None, iconUrls: Optional[Dict[str, Any]] = None,
                 **kwargs):
        super().__init__(**kwargs)
        self.name = None if name is None else JsonLocalizedName(**name)
        self.id = id
        self.iconUrls = iconUrls


class ClanMember(SupercellApiResponse):
    def __init__(self, clanChestPoints: Optional[int] = None, arena: Optional[dict] = None, lastSeen: Optional[str] = None,
                 tag: Optional[str] = None, name: Optional[str] = None, role: Optional[str] = None, expLevel: Optional[int] = None,
...
class Location(SupercellApiResponse):
    def __init__(self, localizedName: Optional[str] = None, id: Optional[int] = None, name: Optional[str] = None, isCountry: Optional[bool] = None,
...
class Clan(SupercellApiResponse):
    def __init__(self, memberList: Optional[List[dict]] = None, tag: Optional[str] = None, clanWarTrophies: Optional[int] = None,
                 requiredTrophies: Optional[int] = None, donationsPerWeek: Optional[int] = None, clanScore: Optional[int] = None,
                 badgeId: Optional[int] = None, clanChestMaxLevel: Optional[int] = None, clanChestStatus: Optional[str] = None,
                 clanChestLevel: Optional[int] = None, name: Optional[str] = None, location: Optional[dict] = None, type: Optional[str] = None,
                 members: Optional[int] = None, description: Optional[str] = None, clanChestPoints: Optional[int] = None,
...
class RiverRaceParticipant(SupercellApiResponse):
    def __init__(self, tag: Optional[str] = None, name: Optional[str] = None, fame: Optional[int] = None, repairPoints: Optional[int] = None,
                 boatAttacks: Optional[int] = None, decksUsed: Optional[int] = None, decksUsedToday: Optional[int] = None, **kwargs):
        super().__init__(**kwargs)
        self.tag = tag
        self.name = name
        self.fame = fame
...
class RiverRaceClan(SupercellApiResponse):
    def __init__(self, tag: Optional[str] = None, clanScore: Optional[int] = None, badgeId: Optional[int] = None, name: Optional[str] = None,
...
class RiverRaceStanding(SupercellApiResponse):
    def __init__(self, rank: Optional[int] = None, trophyChange: Optional[int] = None, clan: Optional[dict] = None, **kwargs):
        super().__init__(**kwargs)
        self.rank = rank
        self.trophyChange = trophyChange
...
class PeriodLogEntry(SupercellApiResponse):
    def __init__(self, clan: Optional[dict] = None, pointsEarned: Optional[int] = None, progressStartOfDay: Optional[int] = None,
                 progressEndOfDay: Optional[int] = None, endOfDayRank: Optional[int] = None, progressEarned: Optional[int] = None,
                 numOfDefensesRemaining: Optional[int] = None, progressEarnedFromDefenses: Optional[int] = None, **kwargs):
        super().__init__(**kwargs)
...
class CurrentRiverRace(SupercellApiResponse):
    def __init__(self, state: Optional[str] = None, clan: Optional[dict] = None, clans: Optional[List[dict]] = None,
                 collectionEndTime: Optional[str] = None, warEndTime: Optional[str] = None, sectionIndex: Optional[int] = None,
                 periodIndex: Optional[int] = None, periodType: Optional[str] = None, periodLogs: Optional[List[dict]] = None, **kwargs):
        super().__init__(**kwargs)
        self.state = state
        self.clan = None if clan is None else RiverRaceClan(**clan)
